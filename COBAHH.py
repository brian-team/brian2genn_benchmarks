...
Ce = Synapses(Pe, P, model='we : siemens',on_pre='ge+=we')
Ci = Synapses(Pi, P, model='wi : siemens',on_pre='gi+=wi')
...
Ce.we = 'randn()*1e-20*nS'  # excitatory synaptic weight
Ci.wi = 'randn()*1e-20*nS'  # inhibitory synaptic weight
